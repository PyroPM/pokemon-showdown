export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	eevee: {
		...
		weightkg: 6.5,
		color: "Brown",
		evos: ["Vaporeon", "Jolteon", "Flareon", "Espeon", "Umbreon", "Leafeon", "Glaceon", "Sylveon", "Nucleon"],
		eggGroups: ["Field"],
	...
	dunsparce: {
		...
		weightkg: 14,
		color: "Yellow",
		evos: ["Dunseraph", "Dudunsparce", "Dudunsparce-Three-Segment"],
		eggGroups: ["Field"],
	},
	gligar: {
		num: 207,
	...
	corsola: {
		...
		evos: ["Corsoreef"],
		eggGroups: ["Water 1", "Water 3"],
		otherFormes: ["Corsola-Nuclear", "Corsola-Galar"],
		formeOrder: ["Corsola", "Corsola-Nuclear", "Corsola-Galar"],
	},
	corsolanuclear: {
		num: 222,
	...
	gliscor: {
		...
		formeOrder: ["Gliscor", "Gliscor-MeNucleara"],
	},
	gliscornuclear: {
		num: 472,
		name: "Gliscor",
